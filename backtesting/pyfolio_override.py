# Some pyfolio functions which have been overridden for 
...
from utils   import save_figs_to_pdf, rp
...
def create_full_tear_sheet(returns,
    ...
    """
    fig_map = {}
    return_fig = False if save_file == None else True
    ...
    fig_map['interesting_times_tear_sheet'] = \
    ...
    if positions is not None:
        ...
        if factor_returns is not None and factor_loadings is not None:
            fig_map['perf_attrib_tear_sheet'] = \
    ...
    if return_fig:
        save_figs_to_pdf(save_file, list(fig_map.values()), close_figs=True)
